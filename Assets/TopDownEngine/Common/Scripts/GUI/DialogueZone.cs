...
namespace MoreMountains.TopDownEngine
{
	...
	public class DialogueZone : ButtonActivated
	{
		...
		public IEnumerator PlayNextDialogue()
		{
			...
			// 	yield break;
			// }
			//VoiceFlowManager.manager.disp.ShouldOpen = false;
			...
			{ 
				...
				//Debug.Log("AI RESP : "+VoiceFlowManager.resp);
			}
